    ...
    public static ArrayList<String> getAutoTrackFragments(Context context) {
        ...
        try {
            ...
            if (e.toString().contains("FileNotFoundException")) {
                LogUtil.d("SensorsDataAutoTrackFragment file not exists.");
            } else {
                LogUtil.printStackTrace(e);
            }
        } finally {
            ...
            if (TextUtils.isEmpty(userAgent)) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
                    try {
                        ...
                        LogUtil.i("WebSettings NoSuchMethod: getDefaultUserAgent");
                    }
                }
    ...
    public static boolean checkHasPermission(Context context, String permission) {
        try {
            ...
            if (result != PackageManager.PERMISSION_GRANTED) {
                LogUtil.i("You can fix this by adding the following to your AndroidManifest.xml file:\n"
            ...
            if (tm != null) {
                if (Build.VERSION.SDK_INT > Build.VERSION_CODES.P) {
                    if (tm.hasCarrierPrivileges()) {
                        ...
                        LogUtil.d("Can not get IMEI info.");
                    }
